                ...
                <div class="card-item">
                    ...
                    <div class="lines">
                        ...
                        <p class="text-center my-1">Rp.150.000</p>
                         <a href="login.php"> <p class="text-center my-1"><b>Grab now!</b> </a></p>
                    </div>
                </div>
        ...
        <div class="card">
            ...
            <div class="cards">
                <div class="card-item">
                    ...
                    <div class="lines">
                        <p class="text-center my-1">Kebaya Pink Creamy</p>
      ...
      <div class="row">
        ...
        <div class="footer-newsletter">
          <h5>Login</h5>
            ...
            <a href="login.php" <button class="btn btn-primary btn-sm mt-2">login</button></a>
          </form>
        </div>
      </div>
      <hr>
